...
//		String pattern = "￦00,000.000"; // ￦1,234.500
...
//		double parsedNum = Double.parseDouble(strNum); // 사용 불가!
		...
		Person[] pArr = {
			...
			new Person("강감찬", 35, "831212-1231231")
		};
...
//		new Person("강감찬", 35, "831212-1231231")
		...
		// String messagePattern = "이름 : {0}, 나이 : {1}, 주민번호 : {2} [{0}]";
		String originalData = 
				"홍길동:20:901010-1234567,이순신:44:771122-1212121,강감찬:35:831212-1231231";
//		String[] strArrData = originalData.split(",");
//		
//		// 일반 for문
//		for(int i=0; i < strArrData.length; i++) {
//			String[] splitData = strArrData[i].split(":");
//			String formatStr2 = MessageFormat.format(messagePattern, splitData);
//			System.out.println(formatStr2);
//		}
