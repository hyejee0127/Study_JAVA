...
//    서브인터페이스도 추상메서드 형태로 보관 하기 때문이다!
interface ITotal extends IHello, IGoodbye {
//	public void sayHello() {} // 오류 발생! 추상메서드 구현이 불가능!!
...
interface SuperManBird {}

class Person {
	String name;
	int age;
}
class SuperMan2 extends Person implements SuperManBird {}
...
class Bird2 extends Animal implements SuperManBird {
	@Override
	public void cry() {}
}
