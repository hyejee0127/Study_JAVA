...
public class Ex1 {
	...
	public static void main(String[] args) {
		...
		Integer i = 10; // Wrapper 클래스 타입은 오토방식/오토언박싱에 의해 자동 변환됨
...
//		System.out.println(bi + bi2); // 일반 산술연산자 사용이 불가능! 
		...
		System.out.println("%2(mod): " + bi.mod(bi2));
		
		System.out.println("-----------------------------------------------------");
		
		double d1 = 2.0;
		double d2 = 1.1;
		System.out.println(d1 - d2); // 2.0 - 1.1 = 0.89999999999999 (= 정확하지 않음)
